...
import { selectFavouritesQuantity } from '../../features/favouritesSlices';
...
export const MainNavigation: FC = () => {
  ...
  const applyQuery = useCallback(
    debounce(e => handleChangeQuery(e), 1000),
    [],
  );
      ...
      <aside className="aside" ref={openRef}>
        ...
        <nav className="main-header__nav main-header__nav--aside">
          <ul className="main-header__list main-header__list--aside">
            <li className="main-header__item">
              <CustomNavLink to="/" text="Home" onClick={handleOpenRef} />
            </li>
            <li className="main-header__item">
              <CustomNavLink
                to="/phones"
          ...
          <ul className="aside__bottom-list">
            <li className="main-header__item aside__link">
              ...
              >
                <FavouritesIcon />
                {quantityFavourites > 0 && (
                  <span className="main-header__text main-header__text--footer">
                    {quantityFavourites}
                  </span>
                )}
              </NavLink>
