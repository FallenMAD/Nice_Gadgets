...
export const fetchAccessoriesDetail = createAsyncThunk<IAccessoriesDetail, string>(
  'accessoriesDetail/fetchAccessoriesDetail',
  async (id: string, { rejectWithValue }) => {
    try {
      const res = await axios.get<IAccessoriesDetail[]>(
        `${BASE_URL}/accessories.json`,
      );
...
export const selectAccessoriesDetail = (state: RootState) =>
  state.accessoriesDetail.accessories;
export const selectAccessoriesDetailStatus = (state: RootState) =>
  state.accessoriesDetail.status;
export const selectAccessoriesDetailError = (state: RootState) =>
  state.accessoriesDetail.error;
