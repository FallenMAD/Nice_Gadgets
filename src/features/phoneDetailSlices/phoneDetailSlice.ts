...
export const selectPhoneDetailStatus = (state: RootState) =>
  state.phoneDetail.status;
export const selectPhoneDetailError = (state: RootState) =>
  state.phoneDetail.error;
