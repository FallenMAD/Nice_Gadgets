...
export const fetchTabletsDetail = createAsyncThunk<ITabletDetail, string>(
...
export const selectTabletDetail = (state: RootState) =>
  state.tabletDetail.tablets;
export const selectTabletDetailStatus = (state: RootState) =>
  state.tabletDetail.status;
export const selectTabletDetailError = (state: RootState) =>
  state.tabletDetail.error;
